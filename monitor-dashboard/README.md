...
- **[index.html](index.html)** — the sample as published at [app.focusalpha.ai/monitor-dashboard](https://app.focusalpha.ai/monitor-dashboard/). Data frozen as of 2026-09-23; it never updates.
