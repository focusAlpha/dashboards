...
- **[index.html](index.html)** — the sample as published at [app.focusalpha.ai/screener-dashboard](https://app.focusalpha.ai/screener-dashboard/). Data frozen as of 2026-09-23; it never updates.
